...
public class SearchEnquiry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_enquiry);
        ...
        ((Spinner)findViewById(R.id.spinner)).setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position==4) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(SearchEnquiry.this);
        ...
        findViewById(R.id.eqsearch).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                clearList();
                if(checkEmpty()==0) {
                    db = new DataBaseHelper(SearchEnquiry.this);
                    if (pos == 1) {
                        c = db.getEnquiry();
                    ...
                    if (c.moveToFirst() && c.getCount() != 0) {
                        ...
                        setOnClickListener();
                        customAdapter = new CustomAdapter(SearchEnquiry.this, fname, name, listenere, classes, eid,activityId);
                        recyclerView.setAdapter(customAdapter);
                        recyclerView.setLayoutManager(new LinearLayoutManager(SearchEnquiry.this));
    ...
    public int alert(int n) {
        AlertDialog alertDialog = new AlertDialog.Builder(SearchEnquiry.this).create();
        ...
        if (activityId!=3) {
            listenere = new CustomAdapter.RecyclerViewClickListener() {
                ...
                public void onClick(View v, int position) {
                    Intent i = new Intent(SearchEnquiry.this, ShowEnquiryData.class);
